...
public class PacketHandler
{
	...
	public void initialize()
	{
		...
		netHandler.registerMessage(PacketElectricRefrigeratedChestMessage.class, ElectricRefrigeratedChestMessage.class, 2, Side.CLIENT);
		netHandler.registerMessage(PacketElectricRefrigeratedChestMessage.class, ElectricRefrigeratedChestMessage.class, 2, Side.SERVER);
		...
		netHandler.registerMessage(PacketPersonalChest.class, PersonalChestMessage.class, 31, Side.CLIENT);
		netHandler.registerMessage(PacketPersonalChest.class, PersonalChestMessage.class, 31, Side.SERVER);
	}

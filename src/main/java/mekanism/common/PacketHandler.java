...
public class PacketHandler
{
	...
	public void initialize()
	{
		...
		netHandler.registerMessage(PacketElectricRefrigeratedChest.class, ElectricRefrigeratedChestMessage.class, 2, Side.CLIENT);
		netHandler.registerMessage(PacketElectricRefrigeratedChest.class, ElectricRefrigeratedChestMessage.class, 2, Side.SERVER);

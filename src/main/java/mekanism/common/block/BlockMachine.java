...
public class BlockMachine extends BlockContainer implements ISpecialBounds, IBlockCTM, ICustomBlockIcon
{
	...
	public float getExplosionResistance(Entity entity, World world, int x, int y, int z, double explosionX, double explosionY, double explosionZ)
    {
		...
		||(MachineType.get(blockType, world.getBlockMetadata(x, y, z)) != MachineType.ELECTRIC_REFRIGERATED_CHEST))
		{
	...
	public static enum MachineType
	{
		...
		ELECTRIC_REFRIGERATED_CHEST(MachineBlock.MACHINE_BLOCK_1, 13, "ElectricRefrigeratedChest", -1, TileEntityElectricRefrigeratedChest.class, true, true, false),
		...
		QUANTUM_ENTANGLOPORTER(MachineBlock.MACHINE_BLOCK_3, 0, "QuantumEntangloporter", 46, TileEntityQuantumEntangloporter.class, true, true, true),
		...
		PERSONAL_CHEST(MachineBlock.MACHINE_BLOCK_3, 7, "PersonalChest", -1, TileEntityPersonalChest.class, false, true, false);
		...
		public double getUsage()
		{
			switch(this)
			{
				...
				case QUANTUM_ENTANGLOPORTER:
					return usage.quantumEntangloporterUsage;
				default:
					return 0;
			}
		}

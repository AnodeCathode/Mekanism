...
public class CommonProxy implements IGuiProvider
{
	 ...
	 * Handles an ELECTRIC_REFRIGERATED_CHEST_CLIENT_OPEN packet via the proxy, not handled on the server-side.
	...
	public void loadConfiguration()
	{
		...
		general.creativeOverrideElectricRefrigeratedChest = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "CreativeOverrideElectricRefrigeratedChest", true).getBoolean();
		...
		usage.quantumEntangloporterUsage = Mekanism.configuration.get("usage", "QuantumEntangloporterUsage", 200D).getDouble();

...
public class InventoryElectricRefrigeratedChest extends InventoryBasic
{
    ...
    public InventoryElectricRefrigeratedChest(EntityPlayer player)
    {
        super("ElectricRefrigeratedChest", false, 55);
        entityPlayer = player;

        read();
    }

    public InventoryElectricRefrigeratedChest(ItemStack stack)
    {
        super("ElectricRefrigeratedChest", false, 55);
        itemStack = stack;

...
public class ItemRenderingHandler implements IItemRenderer
{
	...
	public ModelChest electricRefrigeratedChest = new ModelChest();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		else if(MachineType.get(item) == MachineType.ELECTRIC_REFRIGERATED_CHEST)
		{
			GL11.glPushMatrix();
			ItemBlockMachine chest = (ItemBlockMachine)item.getItem();
			...
			mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.RENDER, "ElectricRefrigeratedChest.png"));

			electricRefrigeratedChest.renderAll();
			GL11.glPopMatrix();
		}

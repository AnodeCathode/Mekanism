...
public class MekanismGenerators implements IModule
{
	...
	public void addRecipes()
	{
		...
		CraftingManager.getInstance().getRecipeList().add(new MekanismRecipe(new ItemStack(GeneratorsBlocks.Generator, 1, 5), new Object[] {
			"SES", "SBS", "ICI", Character.valueOf('S'), new ItemStack(GeneratorsBlocks.Generator, 1, 1), Character.valueOf('E'), "alloyUltimate", Character.valueOf('I'), "plateBlackSteel", Character.valueOf('B'), "ingotBlueSteel", Character.valueOf('C'), MekanismUtils.getEnergyCube(EnergyCubeTier.BASIC)
		}));
